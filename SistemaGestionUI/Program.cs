...
namespace SistemaGestionUI
{
    internal class Program
    {
        ...
        {
            if (ProductoBussiness.CrearProducto(nuevoProducto))
            {
        ...
        {
            var productoModificado = ProductoBussiness.ObtenerProductoPorID(idProductoModificar);
            if (productoModificado != null)
            {
                ...
                if (ProductoBussiness.ModificarProducto(productoModificado))
                {
        ...
        {
            Usuario usuario = UsuarioBusiness.ObtenerUsuarioPorID(idUsuario);
        ...
        static void CrearNuevoUsuario()
        {
            ...
            bool resultado = UsuarioBusiness.CrearUsuario(nuevoUsuario);
        ...
        static void ModificarUsuario()
        {
            ...
            bool resultado = UsuarioBusiness.ModificarUsuario(usuarioModificado);
        ...
        static void EliminarUsuario()
        {
            ...
            bool resultado = UsuarioBusiness.EliminarUsuario(idUsuarioAEliminar);
